...
* Given a gaussian distribution, the likelihood or the probability to get a specific point is
...
Our goal is to find those parameters - if we find them than we can predict the gender by bayes theorem;
