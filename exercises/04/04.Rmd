...
Today we will:
  ...
  * What make an estimator good?
  * Talk on interavel estimation
  * Go throw a reminder on MLE with a motivation for machine learning (a mixture process)

# Another MLE example
Q1 is in the attached file

# Charactristics of a good estimator

  * Unbiased
  * Consistency - It's variance is tending to 0 as n (number of samples) goes to infinity.
...
# MLE motivation (Not for the exam)
