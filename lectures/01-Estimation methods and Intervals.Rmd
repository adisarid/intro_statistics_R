...
I plotted a number of continuous/discrete probability density functions of commonly used distributions. 

Before we continue, identify the distributions using the plot, and write them down on a piece of paper.

Here are your options: Normal, Chi-square, Bernulli, Exponential, Poisson.

```{r recognize the distribution quiz, echo=FALSE, fig.dim=c(10, 6)}
