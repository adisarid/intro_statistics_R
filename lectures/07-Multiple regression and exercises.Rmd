...
A random sample of $n=100$ car owners show that in the state of Virginia, a car drives 23,500 km per year with a sample standard deviation of 3900 km.
   ...
   a. Construct a 95% confidence interval for the average number of kilometers a car is driven annually in Virginia. `23500 + c(-1, 1)*qt(p = 0.995, df = 99)*3900/sqrt(100)`.
