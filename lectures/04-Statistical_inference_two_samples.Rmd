...
We talked about t-test when the variance is unknown and presented two cases (with equal variance and uneqal variance). How would we decide which of the two to use? **a statistical test** of course.

   * We begin by defining a new distribution, the $F$ distribution defined to be the ratio of two independent chi-squarerandom variables, divided by its number of degrees of freedom:
