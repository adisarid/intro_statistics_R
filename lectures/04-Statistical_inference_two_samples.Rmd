...
# Today
   ...
   * Reminder: Goodness of fit hypothesis tests (comparing to distribution)
   
   * Words of caution about HARKing, multiple comparisons, abusing hypothesis tests
   
   * Two sample hypothesis tests
   
   * If time permits: RMarkdown documents
...
```{r}
set.seed(0)
deadlift <- readr::read_csv("data/ipf_lifts.csv", col_types = cols())
