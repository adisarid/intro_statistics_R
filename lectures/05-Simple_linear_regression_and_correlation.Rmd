...
# Non-parametric tests: what and why?

---

# Non-parameteric tests: Mann-Whitney U test (comparing means)

---

# Non-parametric tests: Kolmogorov-Smirnov test (comparing distributions)
