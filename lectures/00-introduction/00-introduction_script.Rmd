...
Questions:
   ...
   1. Which exercise has relatively lower weight values?
   2. Which exercise has higher dispersion?
   3. Can you think of familiar distributions (or a combination of such) which would fit these densities?
...
The boxplot illustrates the quantiles (box ends), the median (line inside the box), the box extends with two wiskers up to $1.5\time IQR$ (the Inter-Quartile-Range). Observations outside the IQR are considered outliers, and marked by a point.
