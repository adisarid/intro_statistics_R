...
The last step is about computing the probability under the null hypothesis (of independence). It is currently not included in the code, you should add it as part of the exercise, with a `mutate` command, which creates a new column `prop` (the multiplication of `prop_elv` and `prop_type`).
